...
#define CUSTOM_MACHINE_NAME "XEO"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 340.15 // mm

  // Horizontal offset from middle of printer to smooth rod center.
  #define DELTA_SMOOTH_ROD_OFFSET 226.70 // mm  Modificado para planicie. Incrementamos y baja hotend (convexo). decrecemos y sube hotend (concavo).

  // Horizontal offset of the universal joints on the end effector.
  #define DELTA_EFFECTOR_OFFSET 35.03 // mm

  // Horizontal offset of the universal joints on the carriages.
  #define DELTA_CARRIAGE_OFFSET 40.25 // mm
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -0 // KosselPro actual: -22.919
  #define Y_PROBE_OFFSET_FROM_EXTRUDER -25  // KosselPro actual: -6.304
  // Kossel Pro note: The correct value is likely -17.45 but I'd rather err on the side of
  // not giving someone a head crash. Use something like G29 Z-0.2 to adjust as needed.
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -6.60 // Increase this if the first layer is too thin (remember: it's a negative number so increase means closer to zero).
  ...
  #define Z_RAISE_BETWEEN_PROBINGS 8.5  // How much the Z axis will be raised when traveling from between next probing points.
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 504.6 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define DEFAULT_RETRACT_ACCELERATION  380    // E acceleration in mm/s^2 for retracts
...
#define DEFAULT_ZJERK                 16.0    // (mm/sec) Must be same as XY for delta
